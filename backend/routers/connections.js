...
ConnectionsRouter.get('/:page', ConnectionsController.getConnections);
...
ConnectionsRouter.put('/:connectionId', ConnectionsController.updateConnection);

//Route to delete a connection for the authenticated user
ConnectionsRouter.delete('/:connectionId', ConnectionsController.deleteConnection);

//Route to get details for a specific connection --- this should return all fields for that connection
ConnectionsRouter.get('/:connectionId', ConnectionsController.getConnectionDetails);
